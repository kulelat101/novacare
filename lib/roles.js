...
export const MODULES = [
  ...
  { label: 'Login Logs', href: '/admin/login-logs', group: 'Admin', icon: 'ClockIcon', roles: [ROLES.NURSE] },
];

export function canAccess(role, href) {
  if (href === '/change-password') return Boolean(role);
...
export function getDefaultRoute(role) {
  if (role === ROLES.PATIENT) return '/discharge-and-billing/billing';
